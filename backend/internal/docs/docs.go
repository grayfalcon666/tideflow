...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/tideflow_internal_service.CommitReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/tideflow_internal_service.CommitResp"
                        }
                    },
                    "409": {
                        "description": "Conflict",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/tideflow_internal_service.HabitStatsResp"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/tideflow_internal_service.LearnWordsResp"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "definitions": {
        ...
        "tideflow_internal_service.CommitReq": {
            "type": "object",
            "properties": {
                "result": {
        ...
        "tideflow_internal_service.CommitResp": {
            "type": "object",
            "properties": {
                "batch_remaining": {
                    "type": "integer"
        ...
        "tideflow_internal_service.DailyHeatmapEntry": {
            "type": "object",
            "properties": {
                "date": {
                    "type": "string"
        ...
        "tideflow_internal_service.HabitStatsResp": {
            "type": "object",
            "properties": {
                "current_streak": {
                    "type": "integer"
                ...
                "heatmap": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/tideflow_internal_service.DailyHeatmapEntry"
                    }
                },
                "today_videos": {
                    "type": "integer"
        ...
        "tideflow_internal_service.LearnWordsResp": {
            "type": "object",
            "properties": {
                "batch_remaining": {
                    "type": "integer"
